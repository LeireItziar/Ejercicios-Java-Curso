...
public class Notas {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < arrayNOTAS.length; i++) {
			...
			if (i % 3 == 0) { // para que saque la linea cada tres vueltas esta,el resto vacio
		...
		System.out.println("-------------------------------------");
		System.out.printf("La media es: \t %10.2f  \n", media / 9);
		//System.out.printf("La media es: ", media / 9);
		System.out.printf("Nota mas alta: \t %10.2f \n", alta);
		System.out.printf("Nota mas baja: \t %10.2f \n", baja);
